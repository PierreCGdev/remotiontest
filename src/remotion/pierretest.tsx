...
const Circle = () => {
  ...
  const scaleValue = interpolate(frame, [0, 15, 20], [1, 0.04, 0], {
    easing: Easing.bezier(0.17, 0.17, 0.00, 1.00),
  ...
  const positionYValue = interpolate(frame, [0, 5, 10, 19], [0, -150, 1200, 0], {
    // plusieurs clés et value
    easing: Easing.bezier(0.17, 0.17, 0.66, 1),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
...
const Circle2 = () => {
  ...
  const positionXValue = interpolate(frame, [1, 5, 15, 20], [300, 400, -800, 0], {
    // plusieurs clés et value
    easing: Easing.bezier(0.17, 0.17, 0.70, 1.00),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
...
const Txt3 = () => {
  ...
  const splitText = () => {
      ...
      const translateOpactity = interpolate(
        frame,
        [start, end],
        [0, 1],
        {
      ...
      const translateTracking = interpolate(
        frame,
        [start, end],
        [20, 0], 
        {
      ...
      const translateRotate = interpolate(
        frame,
        [start, end],
        [-18, 0], 
        {
...
const Border2 = () => {
  ...
  const positionYValue = interpolate(frame, [25, 39], [117, 0], {
    easing: Easing.bezier(0.17, 0.17, 0.67, 1.00),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
  ...
  const positionXValue2 = interpolate(frame, [36,56], [(txtSize.width + marge)/2, 0], {
    easing: Easing.bezier(0.33, 0.00, 0.00, 1.00),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });

  const scaleValueY = interpolate(frame, [25,36], [0,txtSize.height + marge], {
    easing: Easing.bezier(0.17, 0.17, 0.00, 1),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });

  const scaleValueX = interpolate(frame, [36,56], [(txtSize.width + marge)*0.1,(txtSize.width + marge)], {
    easing: Easing.bezier(0.33, 0.00, 0.00, 1.00),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
  ...
  return (
    <div
      style={{
        ...
        borderRadius: marge,
        transform: `translateY(${positionYValue}px) translateX(${positionXValue + positionXValue2}px) rotate(${Rotate}deg)`,
        backgroundColor: `${color1}`,
...
const ShapeSquare1 = () => {
  ...
  const positionXValue = interpolate(frame, [Fstart, Fend], [0,700], {
    // plusieurs clés et value
    easing: Easing.bezier(0.10, 0.00, 0.00, 0.79),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });

  const scaleValue = interpolate(frame, [Fstart, Fend], [0.5, 1], {
    easing: Easing.bezier(0.10, 0.00, 0.00, -0.24),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });

  const Rotate = interpolate(frame, [Fstart, Fend], [0, 180], {
    easing: Easing.bezier(0.00, 0.00, 0.61, 0.82),
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
...
const ShapeRound1 = () => {
  ...
  const Opacity= interpolate(frame, [20+delayMarge, 24+delayMarge, 28+delayMarge, 33+delayMarge], [0, 1, 1, 0], {
    // plusieurs clés et value
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
